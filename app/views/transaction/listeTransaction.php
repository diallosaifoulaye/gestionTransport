                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo WEBROOT ?>transaction/listeTransaction">
                            ...
                            <div class="form-group col-lg-2 col-sm-2">
                                ...
                                <input type="text" name="datedeb"  required class="form-control mydatepicker" id="from"
                                       value="<?php echo $date_deb1 ?>" placeholder="<?php echo $this->lang['date_deb']; ?>" autocomplete="off">&nbsp;&nbsp;
                            </div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="form-group col-lg-2 col-sm-2">
                                ...
                                <input type="text" name="datefin" required class="form-control mydatepicker" id="to"
                                       value="<?php echo $date_fin1 ?>" placeholder="<?php echo $this->lang['date_fin']; ?>" autocomplete="off">
                            </div>
                            <div class="col-md-1" style="width: 4%"></div>
                            <div class="form-group col-lg-2 col-sm-2">
            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <div class="panel-heading" style="height: 55px; background-color: #2f5088">
                        <div class="col-md-11"><h3 class="panel-title pull-left" style="color: white;"> <?php echo $this->lang['listeTransaction'] ?> </h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?= WEBROOT; ?>transaction/listeTransactionPro__/<?php echo $liste; ?>/<?php echo $datedeb; ?>/<?php echo $datefin; ?>">
                                <thead>
                                <tr>

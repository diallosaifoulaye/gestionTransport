    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title"><?php echo $this->lang['reportingRechargement']; ?></h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                <ol class="breadcrumb">
                    <li><a href="<?= WEBROOT.'home/menu'; ?>">  <?php echo $this->lang['accueil']; ?></a></li>
                    <li><a href="<?= WEBROOT.'distrib/reportingRechargement'; ?>">  <?php echo $this->lang['reporting']; ?></a></li>
            ...
            <div class="col-md-12">
                <div class="white-box">
                    <fieldset class="scheduler-border">
                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo WEBROOT ?>distrib/reportingRechargement">
                ...
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        ...
                        <div class="circle-tile-content dark-blue">
                            <div class="circle-tile-description text-faded">  <?php echo $this->lang['nbreTransaction']; ?></div>
                            <div class="circle-tile-number text-faded "><?php echo $dataRechargement->nbreTransaction; ?></div>
                ...
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content dark-blue">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($dataRechargement->montant) ; ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content red">
                            <div class="circle-tile-description text-faded">  <?php echo $this->lang['part_nta']; ?> </div>
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($dataRechargement->partNta); ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content red">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($dataRechargement->commissionDistributeur); ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <br><br>
        <div class="row">
            <?php //var_dump(//$datedebut.' '.$datefin);?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?= WEBROOT; ?>distrib/reportingRechargementProcessing/<?php echo $datedebut; ?>/<?php echo $datefin; ?>/<?php echo $collecteurT; ?>">

                                <thead>
                                <tr>
                                    <th style="text-align: center"><?php echo $this->lang['date']; ?></th>
                                    <th style="text-align: center"><?php echo $this->lang['numeroTransaction']; ?></th>
                                    <th style="text-align: center"><?php echo $this->lang['numeroSerie']; ?></th>
                                    <th style="text-align: center"><?php echo $this->lang['nom']; ?></th>
                                    <th style="text-align: center"><?php echo $this->lang['prenom']; ?></th>
                                    <th style="text-align: center"><?php echo $this->lang['montant']; ?> (XOF)</th>
                                    <th style="text-align: center"><?php echo $this->lang['commission']; ?> (XOF)</th>

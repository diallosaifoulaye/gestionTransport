...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?= ASSETS;?>plugins/images/suNuSVA_logo.png">
...
<section id="wrapper" class="login-register " >
    ...
    <div class="login-box login-sidebar" >
        <div class="blue-box" id="changePassword">
            <form class="form-horizontal form-material" id="passwordChangeform" data-type="update" role="form" name="passwordChangeform" action="<?= WEBROOT ?>home/traitementCode" method="post">
                <br/><br/>
                ...
                <div class="form-group m-t-40">@media only screen and (min-width: 400px) {
                    <div class="col-xs-12">
                        <label for="code_genere" class="control-label"><?php echo $this->lang['codeConfirmation']; ?></label>
                        <input class="form-control" type="text" name="code_genere" id="code_genere" required="" placeholder="Code" onchange="codeConfirmation(this.value)">
                    </div>
                </div>
                ...
                <div class="form-group text-center m-t-20">
                    <div class="col-xs-12">
                        ...
                        <button type="submit" onclick="codeConfirmation()" class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light"><?php echo $this->lang['confirmer']; ?></button>

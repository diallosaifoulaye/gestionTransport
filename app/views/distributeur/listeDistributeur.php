                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="panel-title pull-right">
                                <a href="<?= WEBROOT.'distri/ajoutDistributeurModal'; ?>" class="btn btn-success" style="color: #ffffff"> <i class="fa fa-plus"></i> <?php echo $this->lang['ajoutDistributeur']; ?></a>
                            </h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?= WEBROOT; ?>distri/listeDistributeur">
                                <thead>
                                <tr>
                                    <th> <?php echo $this->lang['pointDistri']; ?></th>
                                    <th> <?php echo $this->lang['nomRespo']; ?></th>
                                    <th><?php echo $this->lang['prenomRespo']; ?></th>

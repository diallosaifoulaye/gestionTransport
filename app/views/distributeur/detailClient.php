                        ...
                        <div class="tab-pane " id="home">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered table-hover table-responsive processing"
                                           data-url="<?= WEBROOT; ?>distrib/rechargementByNumPro/<?= base64_encode($client->idCarte) ?>">
                                        <thead>
                                        <tr>
                                            <th> <?php echo $this->lang['date']; ?></th>
                                            <th> <?php echo $this->lang['num_transaction']; ?></th>
                        ...
                        <div class="tab-pane " id="activationBlocage">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered table-hover table-responsive processing"
                                           data-url="<?= WEBROOT; ?>distrib/activationBlocagePro/<?= base64_encode($client->idCarte) ?>">
                                        <thead>
                                        <tr>
                                            <th> <?php echo $this->lang['date']; ?></th>
                                            <th> <?php echo $this->lang['type']; ?></th>
    ...
    <div class="modal fade" role="dialog" aria-labelledby="gridSystemModalLabel" id="ajoutRechargement" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="<?= WEBROOT ?>distrib/ajoutRechargementDetail">
    ...
    <div class="modal fade" role="dialog" aria-labelledby="gridSystemModalLabel" id="blockerCarte" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="<?= WEBROOT ?>distrib/ajoutBlocageOrActivation">
                    <div class="form-group" style="width: 100%;padding: 10px;">
    ...
    <div class="modal fade" role="dialog" aria-labelledby="gridSystemModalLabel" id="reenrolement" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="<?= WEBROOT ?>distrib/reenrolement">

                    <div class="form-group" style="width: 100%;padding: 10px;">
                        <label for="numcarte" class="control-label"><?php echo $this->lang['num_serie'].' (*) :'; ?></label>
                        <input type="number" id="numcarte" name="numcarte" class="form-control" onkeydown="verifCarte()" placeholder="<?php echo $this->lang['num_serie']; ?>"
                               style="width: 100%">
                        <span id="msg4"></span>
                        <span class="help-block with-errors"> </span>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success" id="valider" disabled none" data-form="my-form" type="submit"><i class="fa fa-check"></i> <?php echo $this->lang['btnValider']; ?></button>
                        <button class="btn btn-default" type="button" data-dismiss="modal"> <i class="fa fa-times"></i> <?php echo $this->lang['btnFermer']; ?> </button>
                    </div>
                </form>
            </div><!-- /.modal-content -->

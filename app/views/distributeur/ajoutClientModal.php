...
<form id="validation" class="form-inline form-validator" data-type="update" role="form" name="form"
      action="<?= WEBROOT ?>distrib/ajoutClient" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <select id="montant_carte" name="montant" class="form-control select2" style="width: 100%" required>
                            <option value=""> Selectionnez un montant</option>

                            <?php foreach ($montant as $oneMontant) { ?>
                                <option value="<?php echo $oneMontant->montant_carte; ?>"> <?php echo $oneMontant->montant_carte; ?></option>
                            <?php } ?>
                        </select>
    ...
    <div class="modal-footer">
        <button class="btn btn-success confirm" data-form="my-form" id="valider" disabled type="submit"><i class="fa fa-check"></i> <?php echo $this->lang['btnValider']; ?>
        </button>
...
<script>
    function verifEmail(){
        $.ajax({
            type: "POST",
            url: "<?= WEBROOT.'distrib/verifExistenceEmail'; ?>",

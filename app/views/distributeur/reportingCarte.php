    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title"><?php echo $this->lang['reportingCarte']; ?></h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                <ol class="breadcrumb">
                    <li><a href="<?= WEBROOT.'home/menu'; ?>">  <?php echo $this->lang['accueil']; ?></a></li>
                    <li><a href="<?= WEBROOT.'distrib/reportingCarte'; ?>">  <?php echo $this->lang['reporting']; ?></a></li>
                    <li class="active"><?php echo $this->lang['carte']; ?></li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-md-12">
                <div class="white-box">
                    <fieldset class="scheduler-border">
                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo WEBROOT ?>distrib/reportingCarte">
                ...
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        ...
                        <div class="circle-tile-content dark-blue">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo $dataCarte->nbreEnrolement; ?></div>
                ...
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content dark-blue">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($dataCarte->montantTotal) ; ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content red">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($dataCarte->partNta); ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content red">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($dataCarte->commissionDistributeur); ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?= WEBROOT; ?>distrib/reportingCarteProcessing/<?php echo $datedebut; ?>/<?php echo $datefin; ?>/<?php echo $collecteurT; ?>">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center"><?php echo $this->lang['solde']; ?> (XOF)</th>

                    ...
                    <div class="col-lg-12">
                        <h3 class="panel-title pull-right">
                            <button type="button" class="open-modal btn btn-success"
                                    data-modal-controller="distri/nouvelleCommissionModal"
                                    data-modal-view="<?= base64_encode("distributeur") ?>/<?= base64_encode("nouvelleCommissionModal") ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?= WEBROOT; ?>distri/listeCommission">
                                <thead>
                                <tr>
                                    <th> <?php echo $this->lang['montantCarte']; ?></th>

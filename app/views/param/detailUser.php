                ...
                <div class="white-box">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="home">
                            ...
                            <form class="form-horizontal form-material" method="post" action="<?= WEBROOT ?>param/updateUtilisateur" data-toggle="validator">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3 col-xs-3">
                                        ...
                                        <div class="col-sm-3 col-xs-3">
                                            <button type="button" class="btn btn-warning"><?= $this->lang['modifier'] ; ?></button>
                                        </div>
                                    </div>
                            </form>

                            <div class="col-sm-3 col-xs-3 pull-right">
                            <form class="form-horizontal form-material" method="post" action="<?= WEBROOT?>param/envoieMail" data-toggle="validator">
                                <input type="hidden" name="id" value="<?php echo $user->id?>">
                                <input type="hidden" name="nom" value="<?php echo $user->nom.' '.$user->prenom?>">
                                <input type="hidden" name="email" value="<?php echo $user->email?>">
                                <input type="hidden" name="login" value="<?php echo $user->login?>">
                                <input type="submit" class="btn btn-success" data-toggle="validator" value="<?= $this->lang['reinitialiser']; ?>">
                            </form>
                                </div>
                    ...
                    <div class="tab-pane " id="picture">
                        <form class="form-horizontal form-material" method="post" enctype="multipart/form-data"  action="<?= WEBROOT ?>param/updatePhoto" data-toggle="validator">
                            <input type="hidden" name="id" value="<?= base64_encode($user->id); ?>" />
                            <div class="form-group">
...
<div class="modal fade" role="dialog" aria-labelledby="gridSystemModalLabel" id="deleteUser" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?= WEBROOT ?>param/updateEtatUser">
                <input type="hidden" name="id" value="<?= base64_encode($user->id); ?>"/>

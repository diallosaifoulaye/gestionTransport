...
<div class="user-profile">
    <div class="dropdown user-pro-body">
        <div><img src="<?= ASSETS; ?>pictures/<?php echo $this->_USER->photo ;?>" alt="user-img" class="img-circle"></div>
...
<div class="user-profile" style="font-weight: bold;padding: 1px 0 20px;color: white;background-color: #325186">
            ...
            <?php
            if($this->sidebar=='sidebar_location') echo  '<br>'.Strtoupper($this->lang['location']).'</br>';
            if($this->sidebar=='sidebar_versement') echo  '<br>'.Strtoupper($this->lang['versements']).'</br>';
            if($this->sidebar=='sidebar_client') echo  '<br>'.Strtoupper($this->lang['client']).'</br>';
            if($this->sidebar=='sidebar_reporting') echo  '<br>'.Strtoupper($this->lang['reporting']).'</br>';

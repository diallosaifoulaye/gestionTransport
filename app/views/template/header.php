...
<head>
    ...
    <link rel="stylesheet" href="<?= ASSETS ?>plugins/jconfirm/css/jquery-confirm.css"/>
    <link rel="stylesheet" href="<?= ASSETS; ?>plugins/passtrength/passtrength.css">
            ...
            <div class="top-left-part" style="padding-left: 30px;">
                ...
                <a class="logo" href="<?php echo WEBROOT ?>menu/menu">
                    ...
                    <b>
                        ...
                        <img src="<?= WEBROOT;?>assets/plugins/images/white-sunusva.png" alt="home" class="dark-logo"/>
...
<!--                        <img src="--><?php //echo ASSETS; ?><!--plugins/images/admin-logo.png" alt="home" class="dark-logo">-->
                    ...
                    <span class="hidden-xs">
                        ...
                        <!--This is light logo text-->
                           <img src="<?= WEBROOT;?>assets/plugins/images/white-sunusva.png" alt="home" class="light-logo">

<!--                        <img src="--><?php //echo ASSETS; ?><!--plugins/images/white-sunusva.png" alt="home" class="light-logo">-->
                     </span>
                </a>

    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title"><?php echo $this->lang['etat_rechargement']; ?></h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang['etat_rechargement']; ?></li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-md-12">
                <div class="white-box">
                    <fieldset class="scheduler-border">
                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo WEBROOT ?>reporting/rechargement">
                ...
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        ...
                        <div class="circle-tile-content dark-blue">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo $rechargement->nb_rechargement; ?></div>
                ...
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content dark-blue">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($rechargement->montant) ; ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content red">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($rechargement->part_nta); ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3">
                    <div class="circle-tile ">
                        <div class="circle-tile-content red">
                            ...
                            <div class="circle-tile-number text-faded "><?php echo \app\core\Utils::getFormatMoney($rechargement->part_distributeur); ?></div>
                            <a class="circle-tile-footer" href="#"><i class="fa fa-chevron-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?= WEBROOT; ?>reporting/rechargementProcessing__/<?php echo $datedebut; ?>/<?php echo $datefin; ?>/<?php echo $distributeurSelected; ?>">
                                <thead>


                                <tr>
                                    <th><?php echo $this->lang['date_rechargement']; ?></th>
                                    <th> <?php echo $this->lang['nom']; ?></th>
                                    <th> <?php echo $this->lang['prenom']; ?></th>
                                    <th> <?php echo $this->lang['num_serie']; ?></th>
                                    <th><?php echo $this->lang['montant_recharge']; ?></th>

...
-->                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="mesinfos">
                        <?php //var_dump($versement->nom);exit;?>
                        ...
                        <table>
                            ...
                            <tr class="param param-inline small">
                                <td style="text-align: right" ><dt><?php echo $this->lang['distributeur']; ?> : </dt></td>
                                <td style="text-align: left"><dd style=": left"><?php echo $versement->nom; ?></dd></td>
                            </tr>
                        </table>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <div class="col-sm-2 pull-left">
                                <form action="<?= WEBROOT.'versement/exportRecuVirementRechargement'; ?>"  method="post" name="form2" target="_blank">

                                    <input name="id" type="hidden" value="<?= $versement->id ?>" />
                        ...
                        <div class="col-lg-6">
                            <a href="<?= WEBROOT ?>versement/versementAgent">

            ...
            <div class="top-left-part" style="padding-left: 30px;">
                ...
                <a class="logo" href="<?php echo WEBROOT ?>menu/menu">
                    ...
                    <b>
                        ...
                        <img src="<?= ASSETS; ?>plugins/images/white-sunusva.png" alt="home" class="dark-logo"/>

                    </b>
                    <!-- Logo text image you can use text also -->
                    <span class="hidden-xs">
                        <!--This is light logo text-->
                        <img src="<?= ASSETS; ?>plugins/images/white-sunusva.png" alt="home" class="light-logo">
                     </span>
                </a>
            </div>
            <!-- /Logo -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="row row-in">
                            <div class="col-lg-4 col-sm-6 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last"><h3 class="counter text-right m-t-15"><?php echo $nbre;?></li>
                                    <li class="col-middle">
                            ...
                            <div class="col-lg-4 col-sm-6 row-in-br  b-r-none">
                                <ul class="col-in">
                                    ...
                                    <li class="col-middle">
                                        <h4><?php echo $this->lang['nombreDePersonnel']; ?></h4><br/> </li>
                                    <h4><?php echo $this->lang['chauffeur']; ?>: <?php echo $nbreChauffeur;?></h4>
                                    <h4><?php echo $this->lang['receveurs']; ?>: <?php echo $nbreReceveur;?></h4>
                                    <h4><?php echo $this->lang['controleurs']; ?>: <?php echo $nbreControleur;?></h4>
                                    <!--                                        <div class="progress">-->
                            ...
                            <div class="col-lg-4 col-sm-6 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last"><h3 class="counter text-right m-t-15"><?php echo $nbreTransaction;?></h3></h3></li>
                                    <li class="col-middle">
                                        <h4><?php echo $this->lang['nombreDeTransaction']; ?></h4><br/> </li>
                                    <h4><?php echo $this->lang['montantTransactionJour']; ?>: <strong><?php
                                            if ($montant ==0) {
                                                echo 0 . ' ' . $this->lang['lrd'];
                                            }else{
                                                echo \app\core\Utils::getFormatMoney($montant). ' '.$this->lang['lrd'];
                                            }
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a href="<?= WEBROOT ?>location/listeBusL">
                                <div class="big_text text1-big">
                                    ...
                                    <p><?php echo $this->lang['location']; ?> <br> _</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a href="<?= WEBROOT ?>versement/collectEncours">
                                <div class="big_text text1-big">
                                    <h3><i class="mdi mdi-account-multiple fa-fw icones-big"></i></h3>

                                    <p><?php echo $this->lang['versements']; ?> <br> _</p>
                                </div>
                            </a>
                        </div>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> © 2019 BY NUMHERIT SA</footer>
        </div>
